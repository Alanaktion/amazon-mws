...
[![Latest Stable Version](https://poser.pugx.org/alanaktion/amazon-mws/v/stable)](https://packagist.org/packages/alanaktion/amazon-mws)
...
```bash
composer require alanaktion/amazon-mws
```
